...
const subscriptionTypes = export type AgeCategory = 'JUNIOR_3_6' | 'SENIOR_7_14' | 'ALL';
...
export interface SubscriptionPlan {
    ...
    ageLabel?: string; // e.g. '3Ц6 лет' | '7Ц14 лет'
    scheduleSlots: string[]; // e.g. [ 18:00 - 19:00, 19:00 - 20:00]
    scheduleDays?: string; // e.g. ѕн —р ѕт
...
const attendanceTypes = export type AttendanceStatus = 'PRESENT' | 'MISSED_BURNT' | 'EXCUSED' | 'present' | 'absent' | 'excused';
...
fs.writeFileSync('types/subscription.ts', subscriptionTypes, 'utf8');
fs.writeFileSync('types/attendance.ts', attendanceTypes, 'utf8');
console.log('Successfully written types/subscription.ts and types/attendance.ts');
