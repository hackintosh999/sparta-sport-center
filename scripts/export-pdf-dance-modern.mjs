...
async function exportDanceModernPoster() {
  ...
  let htmlContent = fs.readFileSync(path.resolve(__dirname, '../public/banner-dance-modern-studio.html'), 'utf-8');
  ...
  console.log('🚀 Launching Puppeteer for 3D Icons Liquid Glass Dance Poster (A4 • 1240×1754 • 300 DPI)...');
  ...
  console.log(`✅ Flawless 3D Icons Liquid Glass Dance Poster PDF generated at: ${outputPdfPath}`);
  console.log(`✅ Flawless 3D Icons Liquid Glass Dance Poster PNG generated at: ${outputPngPath}`);
}

exportDanceModernPoster().catch(err => {
