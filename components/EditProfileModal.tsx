...
import { X, User, Calendar, Activity, Hash, Phone, Loader2, Save } from 'lucide-react';
        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
                ...
                <motion.div
                    ...
                    className="relative w-full max-w-lg bg-[#15171C]/95 border border-white/10 rounded-3xl p-6 sm:p-8 overflow-hidden shadow-2xl backdrop-blur-xl"
                >
                    {/* Header */}
                    ...
                    <form onSubmit={handleSubmit} className="mt-6 space-y-5 font-manrope">
                        ...
                        <div className="pt-4 border-t border-white/10">
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-4 bg-sparta-gold hover:bg-yellow-400 text-black font-russo rounded-xl transition-all shadow-lg shadow-sparta-gold/20 flex items-center justify-center gap-2 uppercase tracking-wider text-sm active:scale-[0.98] disabled:opacity-50"
                            >
                                {loading ? (
