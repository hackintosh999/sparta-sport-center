...
import { X, Download, Share2, Award, Calendar, CheckCircle2, ShieldCheck, Printer } from 'lucide-react';
...
export const CertificateLightboxModal: React.FC<CertificateLightboxModalProps> = ({
    ...
    return (
        <AnimatePresence>
            <div className="fixed inset-0 z-[350] flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-2xl overflow-y-auto">
                {/* Backdrop Click */}
                ...
                <motion.div
                    ...
                    className="relative max-w-2xl w-full my-auto z-10 flex flex-col items-center space-y-4"
                >
                    {/* Top Action Bar */}
                    ...
                    {/* DIPLOMA SHEET (Фирменный диплом Спарты с золотой рамкой) */}
                    <div
                        ref={certRef}
