...
export const SpartaHighlightsModal: React.FC<SpartaHighlightsModalProps> = ({
    ...
    const isStaff = ['coach', 'trainer', 'admin', 'director', 'developer'].includes((userProfile?.role || '').toLowerCase());
    ...
    return (
        <AnimatePresence>
            <div className="fixed inset-0 z-[10000] flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-xl select-none">
                ...
                <motion.div
                    ...
                    className="relative z-10 w-full max-w-lg bg-[#121218] border border-white/20 rounded-[32px] overflow-hidden shadow-2xl flex flex-col max-h-[90vh]"
                >
                    {/* Header */}
                    ...
                    {/* Tab Navigation */}
                    <div className="flex p-2 bg-white/5 border-b border-white/5 gap-1.5 overflow-x-auto no-scrollbar">
                        ...
                        {existingAlbums.length > 0 && (
                            <button
                                ...
                                className={`flex-1 py-2 px-3 rounded-xl text-xs font-black uppercase tracking-wider transition-all whitespace-nowrap flex items-center justify-center gap-1.5 ${
                                    activeTab === 'manage'
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {existingAlbums.map(album => (
                                        <button
                                            ...
                                            className="p-3.5 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 flex flex-col items-center gap-2 group transition-all text-center relative"
                                        >
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center justify-between pb-2 border-b border-white/10">
                                            ...
                                            <button
                                                ...
                                                className="text-xs font-bold text-red-400 hover:text-red-300 flex items-center gap-1 bg-red-500/10 px-2.5 py-1 rounded-lg border border-red-500/20"
                                            >
                                                <Trash2 size={13} />
                                                ...
                                                (selectedAlbumToManage.slides || []).map(slide => (
                                                    ...
                                                    >
                                                        ...
                                                        <button
                                                            ...
                                                            className="p-2 rounded-xl bg-red-500/10 hover:bg-red-500/20 text-red-400 transition-all ml-2 shrink-0"
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-1 shrink-0 ml-2">
                                                        ...
                                                        <button
                                                            ...
                                                            className="p-2 rounded-xl bg-red-500/10 hover:bg-red-500/25 text-red-400 transition-all"
                        ...
                        {activeTab === 'create' && (
                            <form onSubmit={handleCreateAlbum} className="space-y-5">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                        {GRADIENT_PRESETS.map(grad => (
                                            <button
                                                ...
                                                className={`h-12 rounded-2xl ${grad.value} border flex items-center justify-center transition-all relative ${
                                ...
                                <button
                                    ...
                                    className="w-full py-3.5 rounded-2xl bg-sparta-gold hover:brightness-110 text-black font-russo uppercase text-xs shadow-lg shadow-sparta-gold/20 transition-all disabled:opacity-40 flex items-center justify-center gap-2"
                                >
                                    <FolderPlus size={16} />
