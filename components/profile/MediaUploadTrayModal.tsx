    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="px-4 py-3 sm:px-5 sm:py-3.5 border-b border-white/10 flex items-center justify-between bg-black/40 backdrop-blur-md shrink-0">
                    <div className="flex items-center gap-3">
                        {focusedIndex !== null && items.length > 1 ? (
                            <button
                                ...
                                className="p-1.5 rounded-xl bg-white/5 hover:bg-sparta-gold hover:text-black text-white/70 transition-all flex items-center gap-1.5 text-xs font-bold cursor-pointer"
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            type="button"
                            onClick={onAddMore}
                            className="px-3 py-1.5 rounded-xl bg-white/5 hover:bg-white/10 hover:border-sparta-gold/40 border border-white/10 text-white/70 hover:text-white transition-all text-xs font-bold flex items-center gap-1.5 active:scale-95 cursor-pointer"
                        ...
                        <button
                            onClick={onClose}
                            aria-label="Закрыть"
                            className="p-2 rounded-xl bg-white/5 hover:bg-white/15 text-white/50 hover:text-white transition-all active:scale-90 cursor-pointer"
                            title="Закрыть"
                        >
                            <X size={18} />
                        </button>
                ...
                {/* Adaptive Media Canvas */}
                <div className="relative flex-1 bg-[#07070a] overflow-y-auto custom-scrollbar p-3 sm:p-4 flex flex-col items-center justify-center min-h-[260px]">
                    {focusedIndex !== null ? (
                        ...
                        <div className="relative w-full h-full max-h-[55vh] flex items-center justify-center">
                            ...
                            <div className="absolute top-2 right-2 flex items-center gap-1.5 z-30">
                                <button
                                    ...
                                    className="p-2 rounded-xl bg-black/70 hover:bg-sparta-gold hover:text-black text-white/80 transition-all backdrop-blur-md border border-white/10 active:scale-90 cursor-pointer"
                                ...
                                <button
                                    ...
                                    className="p-2 rounded-xl bg-black/70 hover:bg-red-500 text-white/80 hover:text-white backdrop-blur-md transition-all border border-white/10 active:scale-90 cursor-pointer"
                        ...
                        /* MULTI-ITEM ADAPTIVE GALLERY */
                        <div className="w-full max-h-[55vh] overflow-y-auto custom-scrollbar py-1">
                                        ...
                                        >
                                            ...
                                            <div className="absolute top-2 right-2 flex items-center gap-1 z-20">
                                                <button
                                                    ...
                                                    className="p-1.5 rounded-xl bg-black/80 hover:bg-sparta-gold hover:text-black text-white/90 backdrop-blur-md transition-all border border-white/10 active:scale-90 shadow-md cursor-pointer"
                                                ...
                                                <button
                                                    ...
                                                    className="p-1.5 rounded-xl bg-black/80 hover:bg-red-500 text-white backdrop-blur-md transition-all border border-white/10 active:scale-90 shadow-md cursor-pointer"
                                            ...
                                            {isMenuOpen && (
                                                ...
                                                >
                                                    <button
                                                        ...
                                                        className="w-full px-2.5 py-1.5 rounded-xl text-left text-xs font-bold text-white hover:bg-sparta-gold hover:text-black transition-colors flex items-center gap-2 cursor-pointer"
                                                    >
                                                        <RefreshCw size={12} />
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full px-2.5 py-1.5 rounded-xl text-left text-xs font-bold text-white hover:bg-white/10 transition-colors flex items-center gap-2 cursor-pointer"
                                                    >
                                                        <Maximize2 size={12} />
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full px-2.5 py-1.5 rounded-xl text-left text-xs font-bold text-red-400 hover:bg-red-500/20 transition-colors flex items-center gap-2 cursor-pointer"
                                                    >
                                                        <Trash2 size={12} />
                                                        <span>Удалить</span>
                                                    </button>
...
export default MediaUploadTrayModal;
