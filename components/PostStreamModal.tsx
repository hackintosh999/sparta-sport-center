...
import { CheckCircle2, Download, Share2, Trash2, Globe, Film, Check } from 'lucide-react';
...
export const PostStreamModal: React.FC<PostStreamModalProps> = ({
    ...
    return (
        <BaseModal
            ...
            zIndex="z-[100]"
        >
            <div className="space-y-6 text-left font-manrope">
                {/* Header */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <button
                        ...
                        className={`p-4 rounded-2xl border transition-all flex items-center gap-3 text-left cursor-pointer ${
                            isPublished
                    ...
                    <button
                        ...
                        className="p-4 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 text-white transition-all flex items-center gap-3 text-left cursor-pointer"
                    >
                    ...
                    <button
                        onClick={onClose}
                        className="p-4 rounded-2xl bg-white/5 hover:bg-red-500/20 border border-white/10 hover:border-red-500/40 text-white/60 hover:text-red-400 transition-all flex items-center gap-3 text-left cursor-pointer"
                    >
...
export default PostStreamModal;
