            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-md bg-[#1a1a1a] border border-white/10 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
                    ...
                    >
                            ...
                            <div className="grid grid-cols-4 gap-2 mb-8">
                                {presetAmounts.map((preset) => (
                                    <button
                                        ...
                                        className={`py-2 rounded-xl text-sm font-bold transition-all border ${amount === preset.toString()
                        ...
                        <div className="p-6 border-t border-white/10 shrink-0 bg-[#1a1a1a]">
                            <button
                                ...
                                className="w-full py-4 bg-sparta-gold hover:bg-yellow-500 text-black rounded-xl font-russo text-lg uppercase transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {isProcessing ? (
                                    <>
