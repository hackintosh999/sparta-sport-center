...
const TermsModal: React.FC<TermsModalProps> = ({ isOpen, onClose }) => {
    return (
        <BaseModal
            ...
            glowColor="amber"
        >
            <div className="bg-[#1a1a1a] rounded-2xl w-full max-h-[calc(100dvh-2rem)] sm:max-h-[85vh] overflow-hidden flex flex-col">
                {/* Header */}
                <div className="p-4 sm:p-6 border-b border-white/10 flex items-center justify-between bg-[#151515] gap-3">
                    <h2 className="font-russo text-base sm:text-xl md:text-2xl text-white leading-tight">Политика в отношении обработки персональных данных</h2>
                    <button
                        onClick={onClose}
                        aria-label="Закрыть"
                ...
                {/* Content */}
                <div className="p-4 sm:p-6 md:p-8 overflow-y-auto font-manrope text-white/80 space-y-4 sm:space-y-6 custom-scrollbar text-xs sm:text-sm leading-relaxed">
                    <section>
                        <h3 className="text-sm sm:text-base font-bold text-white mb-2">1. Общие положения</h3>
                    ...
                    <section>
                        <h3 className="text-sm sm:text-base font-bold text-white mb-2">2. Основные понятия, используемые в Политике</h3>
                    ...
                    <section>
                        <h3 className="text-sm sm:text-base font-bold text-white mb-2">3. Оператор может обрабатывать следующие персональные данные</h3>
                    ...
                    <section>
                        <h3 className="text-sm sm:text-base font-bold text-white mb-2">4. Цели обработки персональных данных</h3>
                    ...
                    <section>
                        <h3 className="text-sm sm:text-base font-bold text-white mb-2">7-10. Условия, порядок сбора и передачи</h3>
                    ...
                    <section>
                        <h3 className="text-sm sm:text-base font-bold text-white mb-2">12. Заключительные положения</h3>
                ...
                {/* Footer */}
                <div className="p-4 sm:p-6 pb-[calc(1rem+env(safe-area-inset-bottom,0px))] sm:pb-6 border-t border-white/10 bg-[#151515] flex justify-end">
                    <button
                        onClick={onClose}
                        className="w-full sm:w-auto px-6 py-2.5 bg-sparta-gold text-black font-bold rounded-xl hover:bg-yellow-500 transition-colors cursor-pointer text-sm"
                    >
                        Понятно
                    </button>
                </div>
