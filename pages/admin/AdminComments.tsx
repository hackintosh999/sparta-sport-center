...
import { Trash2, MessageSquare, ExternalLink, Shield, Pin, Search, Filter, Loader, Send, CheckSquare, Square, X, Copy, MessageCircle, Ban, Edit2, EyeOff, Eye, Unlock, Clock, BadgeCheck, Code, Star } from 'lucide-react';
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        {comment.userName}
                                                        {comment.userRole === 'admin' && <BadgeCheck size={12} className="text-blue-500" />}
                                                        {comment.userRole === 'director' && <Star size={12} className="text-purple-500" />}
                                                        {comment.userRole === 'developer' && <Code size={12} className="text-cyan-500" />}
                                                    </p>
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex justify-end gap-2 opacity-100 transition-opacity">
                                                <button
                                                    ...
                                                    className="p-2 hover:bg-white/10 text-white/10 hover:text-white rounded-lg transition-colors"
                                                    title="Редактировать"
                                                >
                                                    <Edit2 size={16} />
                                                </button>
                                                <button
                                                    ...
                                                    className={`p-2 rounded-lg transition-all ${replyingTo === comment.id ? 'bg-sparta-gold text-black' : 'hover:bg-white/10 text-white/10 hover:text-white'}`}
                                                    title="Ответить"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className={`p-2 rounded-lg transition-all ${comment.isPinned ? 'bg-sparta-gold text-black' : 'hover:bg-white/10 text-white/10 hover:text-white'}`}
                                                ...
                                                <button
                                                    ...
                                                    className={`p-2 rounded-lg transition-all ${comment.isHidden ? 'bg-white/20 text-white' : 'hover:bg-white/10 text-white/10 hover:text-white'}`}
                                                ...
                                                <button
                                                    ...
                                                    className={`p-2 rounded-lg transition-all ${userMap[comment.userId]?.status === 'deleted' ? 'bg-red-500/20 text-red-400' :
                                                        (userMap[comment.userId]?.commentBanUntil && new Date(userMap[comment.userId].commentBanUntil.seconds * 1000) > new Date()) ? 'bg-orange-500/20 text-orange-400' :
                                                            'hover:bg-white/10 text-white/10 hover:text-white'
                                                        }`}
                                                ...
                                                <button
                                                    ...
                                                    className="p-2 hover:bg-red-500/20 text-white/10 hover:text-red-400 rounded-lg transition-colors"
                                                    title="Удалить"
                                                >
                                                    <Trash2 size={16} />
                                                </button>
